  ...
  async function fetchOrders() {
    try {
      let response = await axios.post(
        "http://localhost:3001/orders/your_orders",
    ...
    `}
        ...
        <div className="ordermaincontainer">
          ...
          {live_order_info.length > 0 ? (
              ...
              <div className="live-order-items">
                <div className="indi-order" style={{ alignItems: "center" }}>
                  <div>
                    ...
                    <label
                      style={{ color: "white" }}
                      data-testid="rendered-live-order-id-test"
                    >
                      {orders.order_id}
                    </label>
                  </div>
            ...
            <label style={{ color: "#F85606", paddingLeft: "1%" }}>
              No live orders to display.
            </label>
          )}
          ...
          {order_history_info.length > 0 ? (
            order_history_info
              .slice()
              .sort((x, y) => y.order_id.localeCompare(x.order_id))
              .map((orders) => (
                <div className="order-history-items">
                  <div className="indi-order" style={{ alignItems: "center" }}>
                    <div>
                      ...
                      <br />
                      <label data-testid="rendered-order-history-id-test">
                        {orders.order_id}
                      </label>
                    </div>
                    ...
                    <div>
                      ...
                      <br />
                      <label data-testid="order-history-item">
                        {orders.order_status}
                      </label>
                    </div>
