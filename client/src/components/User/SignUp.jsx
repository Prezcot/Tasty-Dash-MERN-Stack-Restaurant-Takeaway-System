...
function SignUp()
{
    ...
    async function handleSignUp(event)
    {
        ...
        await axios.post("http://192.168.1.121:3001/users/signup",{signupusername,email,phonenumber,signuppassword,cnfrmpassword}).then(()=>changePage("Menu"));
            ...
            <div style={{"margin-top":"5vh","border":"0.75vh solid black","padding":"2vh","border-radius":"15px"}}>
                ...
                <form onSubmit={handleSignUp}>
                    ...
                    <center>
                        ...
                        <p>Already a member ? <b style={{cursor:"pointer"}} onClick={()=>handleMove}>Sign In</b></p>
                    </center>
                </form>
            </div>
        </div>
