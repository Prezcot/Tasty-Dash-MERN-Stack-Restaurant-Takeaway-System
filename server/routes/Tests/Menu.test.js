...
beforeAll(async () => {
    ...
    const menu = new Menuitem({itemName: "FakeItem", itemDescription: "This is a fake menu item", itemPrice: 10.99, itemImage: "fake_image.jpg", itemType: "FakeType"});
    menu.save();
    app=express();
  ...
  describe('Menu Route Test', () => {
    ...
    it('should delete a menu item', async () => {
        ...
        const response = await request(app).delete(`/menu/delete/${encodeURIComponent(newItem.itemName)}`);
